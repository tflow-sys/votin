...
const Dashboard = () => {
  const { getUpcomingElections, getOngoingElections, getArchivedElections } =
    useElection();
                  ...
                  <Card>
                    <CardContent className="pt-6 flex flex-col items-center justify-center text-center p-8">
                      ...
                      <p className="text-muted-foreground">
                        There are no elections currently in progress. Check the
                        upcoming tab for scheduled elections.
                      </p>
                    </CardContent>
                  </Card>
                )}
                ...
                {upcomingElections.length > 0 ? (
                  ...
                  <Card>
                    <CardContent className="pt-6 flex flex-col items-center justify-center text-center p-8">
                      ...
                      <p className="text-muted-foreground">
                        There are no elections scheduled at the moment. Check
                ...
                {archivedElections.length > 0 ? (
                  ...
                  <Card>
                    <CardContent className="pt-6 flex flex-col items-center justify-center text-center p-8">
                      ...
                      <p className="text-muted-foreground">
                        There are no past elections in the archive. Once
                        elections are completed, they will appear here.
                      </p>
                    </CardContent>
                  </Card>
                )}
                ...
                <div className="space-y-4">
                  {notifications.map((notification) => (
                    <div
                      ...
                      className={`border-b pb-3 last:border-0 last:pb-0 ${
                        !notification.read
                          ? "bg-muted/50 -mx-2 px-2 py-2 rounded"
                          : ""
                      }`}
                    >
                      <h4
